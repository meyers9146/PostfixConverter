	...
	public static void prompt() {
		...
		while(again == true) {
			...
			try {
				...
				//Run functions as selected
				case '1':
					System.out.println("Infix: " + NotationV2.convertInfixToPostfix(expr));
					break;
				case '2':
					System.out.println("Postfix: " + NotationV2.convertPostfixToInfix(expr));
					break;
				case '3':
					System.out.println("Answer: " + NotationV2.evaluatePostfixExpression(expr));
					break;
				case '4':
					System.out.println("Answer: " + NotationV2.evaluateInfixExpression(expr));
					break;
				case '0':
					again = false;
					break;
